...
export default function Interview() {
  ...
  const evaluateAnswer = useCallback(
    async (answerOverride = null) => {
      // Guard against overlapping calls -- e.g. the user double-clicking
      // "Next" or the auto-submit timer firing while a request from a
      // manual click is already in flight. Without this, two evaluations
      // for the same question can race and both try to advance the
      // question number.
